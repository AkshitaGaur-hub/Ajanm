    ...
    <>
      ...
      <div className="aboutus">
        ...
        <div className="team flex justify-center gap-5">
          <div className="card1">
            <div className="cardt">
              <h2 className='card-title'><b>Prasoon Gupta</b></h2>
          ...
          <div className="card1">
            <div className="cardt">
              <h2 className='card-title'><b>Vinit Dixit</b></h2>
          ...
          <div className="card1">
            <div className="cardt">
              <h2 className='card-title'><b>Ashok Birla</b></h2>
